...
import { getCollectionName, statuses, uploadImageToCloudinary } from "../../../Constants";
            ...
            <div className="row m-0">
              {
                imageUrls.map((url, index) => (
                  <div key={index} className="col-md-3 col-2 p-1" style={{ marginLeft: "10px", display: "flex", alignItems: "self-start" }}>
                    <img src={url} height={"55px"} width={"55px"} />
                    <button
                      type="button"
